...
#warning 这里的cell的height是44,需要在layoutSubviews里面获取
    ...
    if (self) {
        ...
        [self.timeLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.mas_equalTo(weakSelf.timePointView.mas_left).offset(-3);
        }];
        [self.contentView addSubview:self.moneyLabel];
        [self.moneyLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.centerY.equalTo(weakSelf.timePointView);
            make.left.mas_equalTo(weakSelf.timePointView.mas_right).offset(3);
        }];
        //* --------------------------华丽的分割线----------------------------- */
        ...
        [self.leftRemarkLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(weakSelf.leftCategoryNameLabel.mas_bottom);
        ...
        [self.leftRemarkPhotoBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.mas_equalTo(weakSelf.categoryImageBtn.mas_left).offset(-5);
            make.centerY.equalTo(weakSelf.categoryImageBtn);
        }];
        ...
        [self.rightRemarkLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(weakSelf.rightCategoryNameLabel.mas_bottom);
        ...
        [self.rightRemarkPhotoBtn mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.mas_equalTo(weakSelf.categoryImageBtn.mas_right).offset(5);
            make.centerY.equalTo(weakSelf.categoryImageBtn);
        }];
    }
    return self;

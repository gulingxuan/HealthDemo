...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        [self.categoryName_moneyLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(weakSelf.lineView.mas_left).offset(10.5);
        ...
        [self.dayLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.mas_equalTo(weakSelf.lineView.mas_left).offset(-20);
        }];
        
        [self.contentView addSubview:self.year_monthLabel];
        [self.year_monthLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(weakSelf.contentView);
            make.right.mas_equalTo(weakSelf.smallLineView.mas_left).offset(-5);
        ...
        [self.numberLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.mas_equalTo(weakSelf.year_monthLabel.mas_bottom);
            make.right.mas_equalTo(weakSelf.dayLabel.mas_left).offset(-5);
        }];
        
        [self.contentView addSubview:self.remarkLabel];
        [self.remarkLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.mas_equalTo(weakSelf.categoryName_moneyLabel.mas_bottom);

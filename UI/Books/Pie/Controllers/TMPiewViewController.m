...
- (void)layoutSubviews {
    ...
    [self.rightItemLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerY.mas_equalTo(weakSelf.leftItemLabel);
    }];
    ...
    [iCar mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(weakSelf.leftItemLabel.mas_bottom).offset(10);
    ...
    [self.yearLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.mas_equalTo(iCar.mas_bottom);
    ...
    [self.categoryTitleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(weakSelf.view);
        make.top.mas_equalTo(weakSelf.yearLabel.mas_bottom).offset(30);
    }];
    ...
    [self.moneyLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(weakSelf.view);
        make.top.mas_equalTo(weakSelf.categoryTitleLabel.mas_bottom).offset(5);
    }];
    ...
    [redLineView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(weakSelf.moneyLabel.mas_bottom).offset(5);
    ...
    [self.pieView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerX.equalTo(weakSelf.view);
        make.top.mas_equalTo(redLineView.mas_bottom).offset(5);
    }];
    [self tapRightItemLabel];
    ...
    [self.percentLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(weakSelf.view);
        make.top.mas_equalTo(weakSelf.categoryBtn.mas_bottom).offset(5);
    }];
    ...
    [self.countLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(weakSelf.pieView.mas_bottom).offset(20);
        make.centerX.equalTo(weakSelf.view);
    }];
